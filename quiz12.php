<?php
// Load the XML file
$xml = simplexml_load_file('mistal_IT2C_QUIZMANIA.xml/quiz12.xml');
...
<html>
<head>
  <title>QUIZMANIA QUIZ 12</title>
  <link rel="stylesheet" type="text/css" href="css/quiz.css">
  
</head>
<body onload="startTimer()">
    <div class="container">
        <h1>QUIZMANIA QUIZ 12</h1>
